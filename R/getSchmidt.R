...
getSchmidt	<-	function(temperature, gas){
	...
	Schmidt <-	cbind(Schmidt,"O2"=c(1800.6,120.1,3.7818,0.047608))
	Schmidt	<-	cbind(Schmidt,"CO2"=c(1911.1,118.11,3.4527,0.04132))
	Schmidt	<-	cbind(Schmidt,"CH4"=c(1897.8,114.28,3.2902,0.039061))
	Schmidt	<-	cbind(Schmidt,"SF6"=c(3255.3,217.13,6.8370,0.086070))
	Schmidt	<-	cbind(Schmidt,"N2O"=c(2055.6,137.11,4.3173,0.05435))
	Schmidt	<-	cbind(Schmidt,"Ar"=c(1759.7,117.37,3.6959,0.046527))
