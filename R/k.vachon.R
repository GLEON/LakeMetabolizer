...
# default values of parA=2.51, parB=1.48, parC=0.39
...
#'@export
k.vachon.base <- function(wnd,lake.area,parA=2.51,parB=1.48,parC=0.39){
  U10 <- wnd  #This function uses just the wind speed it is supplied
  k600 <- parA + parB*U10 + parC*U10*log10(lake.area/1000000) # units in cm h-1
